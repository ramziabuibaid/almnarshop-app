      ...
      <div className="space-y-4 sm:space-y-6 font-cairo" dir="rtl">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 font-cairo">صندوق المستودع</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1 text-sm sm:text-base font-cairo">سجل مالي مستمر للمستودع</p>
          </div>
