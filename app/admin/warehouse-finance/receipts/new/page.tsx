    ...
    <AdminLayout>
      <div className="space-y-6" dir="rtl">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">إضافة سند قبض جديد - المستودع</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">إنشاء سند قبض جديد للمستودع</p>
          </div>
          <button
