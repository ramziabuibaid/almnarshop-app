      ...
      <AdminLayout>
        <div className="flex items-center justify-center min-h-[60vh]" dir="rtl">
          <div className="text-center">
            ...
            <p className="text-gray-600">جاري تحميل سند القبض...</p>
          </div>
        </div>
      </AdminLayout>
    );
    ...
    <AdminLayout>
      <div className="space-y-6" dir="rtl">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">تعديل سند قبض - المستودع</h1>
            <p className="text-gray-600 mt-1">تعديل سند القبض رقم: {receiptId}</p>
          </div>
          <button
