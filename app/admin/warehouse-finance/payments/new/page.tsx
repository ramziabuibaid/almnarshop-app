...
import { createWarehousePayment, getAllCustomers } from '@/lib/api';
import {
  Loader2,
  Save,
  ArrowRight,
...
function PaymentForm() {
  ...
  const loadCustomers = async () => {
    try {
      ...
      console.error('[NewWarehousePayment] Failed to load customers:', err);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('[NewWarehousePayment] Failed to create payment:', err);
