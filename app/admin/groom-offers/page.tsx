      ...
      <div className="space-y-6 font-cairo" dir="rtl">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 font-cairo">إدارة عروض العرسان</h1>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pr-10 pl-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-900 font-cairo"
              />
            </div>
            <div className="flex items-center gap-2">
              <label className="text-sm font-medium text-gray-700 font-cairo whitespace-nowrap">الحالة:</label>
              <select
                value={statusFilter}
                onChange={(e) => setStatusFilter(e.target.value)}
                className="flex-1 sm:flex-none px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-900 font-cairo"
              >
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredOffers.map((offer) => (
                    <tr key={offer.QuotationID} className="hover:bg-purple-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 font-cairo">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {canAccountant ? (
                          <select
                            ...
                            className={`px-2 py-1 text-xs font-semibold rounded-lg border border-gray-300 focus:outline-none focus:ring-1 focus:ring-purple-500 cursor-pointer font-cairo ${updatingStatusId === offer.QuotationID ? 'opacity-50' : ''
                              }`}
                          >
                            {STATUS_OPTIONS.map((status) => (
                          ...
                          <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-lg bg-gray-100 text-gray-800 font-cairo">
                            {offer.Status}
                          </span>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900 font-cairo">
