...
export default function ChecksPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'سلم للزبون ولم يدفع':
        return 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 border-red-200';
      ...
      default:
        return 'bg-gray-100 dark:bg-slate-700/50 text-gray-800 dark:text-gray-200 border-gray-200 dark:border-slate-700';
    }
  };
    ...
    <AdminLayout>
      <div dir="rtl" className="space-y-4 sm:space-y-6 font-cairo">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">الشيكات الراجعة</h1>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <button
              onClick={loadData}
              className="flex-1 sm:flex-none px-3 sm:px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700/50 flex items-center justify-center gap-2 transition-colors"
            >
            ...
            <button
              ...
              className="flex-1 sm:flex-none px-4 py-2 bg-gray-900 dark:bg-slate-700 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-slate-600 flex items-center justify-center gap-2 transition-colors"
            >
              <Plus size={18} />
              <span>إضافة شيك</span>
            </button>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full border border-gray-300 dark:border-slate-600 rounded-lg py-2 pr-10 pl-3 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 text-right font-semibold text-gray-900 dark:text-gray-100 text-sm sm:text-base"
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="flex-1 sm:flex-none border border-gray-300 dark:border-slate-600 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 text-right font-semibold text-gray-900 dark:text-gray-100 text-sm sm:text-base min-w-[140px]"
              >
            ...
            <button
              ...
              className="px-4 py-2 bg-gray-900 dark:bg-slate-700 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-slate-600 transition-colors text-sm sm:text-base"
            >
              بحث
            </button>
          </div>
        ...
        {checks.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-4">
            <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-3 sm:p-4">
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1">في المخزن</div>
            ...
            <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-3 sm:p-4">
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1">في المحل</div>
            ...
            <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-3 sm:p-4">
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-1">سلم للزبون ولم يدفع</div>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-200 dark:border-slate-700 rounded-lg p-3 sm:p-4 text-white">
              <div className="text-xs sm:text-sm text-gray-300 dark:text-gray-600 mb-1">المجموع</div>
        ...
        <div className="hidden md:block bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-gray-900 dark:text-gray-100" dir="rtl">
              <thead className="bg-gray-50 dark:bg-slate-800/50 border-b border-gray-200 dark:border-slate-700">
                <tr>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">رقم الشيك</th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider min-w-[200px]">الزبون</th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">المبلغ</th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider min-w-[140px]">تاريخ الإرجاع</th>
                  ...
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">صور</th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">إجراءات</th>
                </tr>
              </thead>
              <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200">
                {loading ? (
                  ...
                  filteredChecks.map((chk) => (
                    <tr key={chk.check_id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                      <td className="px-4 py-3">
                        <div className="font-semibold text-gray-900 dark:text-gray-100">{chk.check_id}</div>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="font-bold text-gray-900 dark:text-gray-100">₪{(chk.amount || 0).toFixed(2)}</span>
                        </div>
                      </td>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {getActionButtons(chk.status, chk.check_id).map((action, idx) => (
                                <button
                                  ...
                                  className={`text-xs px-2.5 py-1 border border-gray-300 dark:border-slate-600 rounded-md hover:bg-gray-100 dark:hover:bg-slate-700 hover:border-gray-400 transition-colors text-gray-900 dark:text-gray-100 font-medium ${
                        ...
                        <div className="flex flex-col gap-2">
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="px-3 py-1.5 text-xs bg-gray-900 dark:bg-slate-700 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-slate-600 flex items-center gap-1.5 transition-colors"
                            >
                              <Edit size={14} />
                              تعديل
                            </button>
                          ...
                          {chk.notes && (
                            <div className="text-xs text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-slate-800/50 px-2 py-1 rounded border border-gray-200 dark:border-slate-700">
        ...
        <div className="md:hidden space-y-3">
          {loading ? (
            ...
            <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-8 text-center text-gray-500 dark:text-gray-400">
              لا توجد بيانات
            </div>
          ) : (
            filteredChecks.map((chk) => (
              <div key={chk.check_id} className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-4 shadow-sm">
                {/* Header */}
                <div className="flex items-start justify-between mb-3 pb-3 border-b border-gray-200 dark:border-slate-700">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <FileCheck size={18} className="text-gray-400 dark:text-gray-500" />
                      <span className="font-bold text-gray-900 dark:text-gray-100 text-base">{chk.check_id}</span>
                    </div>
                    {userMap.get(chk.created_by || chk.createdBy || chk.user_id || '') && (
                ...
                {getActionButtons(chk.status, chk.check_id).length > 0 && (
                  <div className="mb-3 pt-3 border-t border-gray-200 dark:border-slate-700">
                    <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">إجراءات الحالة</div>
                    <div className="flex flex-wrap gap-2">
                      {getActionButtons(chk.status, chk.check_id).map((action, idx) => (
                        <button
                          ...
                          onClick={() => handleStatusChangeClick(chk.check_id, action.newStatus, action.label)}
                          disabled={updatingStatus === chk.check_id}
                          className={`text-xs px-3 py-1.5 border border-gray-300 dark:border-slate-600 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 hover:border-gray-400 transition-colors text-gray-900 dark:text-gray-100 font-medium ${
                            updatingStatus === chk.check_id ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                          }`}
                        >
                          {action.label}
                ...
                <div className="flex items-center gap-2 mb-3">
                  <DollarSign size={16} className="text-gray-400 dark:text-gray-500" />
                  <span className="font-bold text-lg text-gray-900 dark:text-gray-100">₪{(chk.amount || 0).toFixed(2)}</span>
                </div>

                {/* Notes */}
                {chk.notes && (
                  <div className="mb-3 p-2 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
                    <div className="text-xs text-gray-600 dark:text-gray-400 mb-1">ملاحظات:</div>
                    <div className="text-sm text-gray-900 dark:text-gray-100">{chk.notes}</div>
                  </div>
                )}
              ...
              <div className="p-4 sm:p-6 space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-2 py-1 text-xs text-gray-700 dark:text-gray-300 hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-lg transition-colors"
                  ...
                  <div className="relative" ref={customerDropdownRef}>
                    <input
                      ...
                      className="w-full border border-gray-300 dark:border-slate-600 text-gray-900 dark:text-gray-100 font-semibold rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 text-right"
                    />
                      ...
                      <div className="absolute z-50 w-full mt-1 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                        {filteredCustomers.map((c) => (
                          <button
                            ...
                            className="w-full text-right px-4 py-2 hover:bg-gray-100 dark:hover:bg-slate-700 text-gray-900 dark:text-gray-100"
                          >
                            <div className="flex items-center gap-3">
                              <div className="flex-1 min-w-0">
                                <div className="flex flex-col gap-1">
                                  <span className="text-sm font-medium">{c.Name || c.name}</span>
                                  <span className="text-xs text-gray-600 dark:text-gray-400" dir="rtl">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        <label className="flex-1 cursor-pointer">
                          <input
                            ...
                            id="image-front-file"
                          />
                          <div className="w-full border border-gray-300 dark:border-slate-600 text-gray-900 dark:text-gray-100 font-semibold rounded-lg py-2 px-3 focus-within:outline-none focus-within:ring-2 focus-within:ring-gray-900 text-right text-sm bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors flex items-center justify-center gap-2">
                            <ImageIcon size={18} />
                        ...
                        {checkForm.imageFrontFile && (
                          <button
                            ...
                            className="px-3 py-2 text-red-600 dark:text-red-400 hover:bg-red-50 rounded-lg transition-colors"
                            title="إزالة الصورة"
                          >
                            <X size={18} />
                          </button>
                      ...
                      <input
                        ...
                        className="w-full border border-gray-300 dark:border-slate-600 text-gray-900 dark:text-gray-100 font-semibold rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 text-right text-sm"
                ...
                <div className="flex items-center gap-3 pt-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors font-semibold"
                  ...
                  <button
                    ...
                    disabled={checkSaving}
                    className="flex-1 px-4 py-2.5 bg-gray-900 dark:bg-slate-700 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-slate-600 flex items-center justify-center gap-2 disabled:opacity-50 transition-colors font-semibold"
                  >
                    {checkSaving ? (
                      <>
          ...
          >
            ...
            >
              ...
              <div className="sticky top-0 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 px-3 sm:px-6 py-3 sm:py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 z-10 flex-shrink-0">
                <div className="flex-1 min-w-0">
                  <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-100">عرض الشيك</h2>
                  <p className="text-sm text-gray-600 dark:text-gray-400">#{viewingCheck.check_id}</p>
                </div>
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  <button
                    onClick={() => openEditModal(viewingCheck)}
                    className="flex items-center justify-center gap-1.5 px-3 py-1.5 text-sm bg-gray-900 dark:bg-slate-700 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-slate-600 transition-colors"
                  >
                    <Edit size={16} />
              ...
              <div className="flex-1 overflow-y-auto p-3 sm:p-6 min-h-0">
                <div className="space-y-4 sm:space-y-6">
                  {/* Customer Info */}
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-slate-700 pb-2 mb-3 sm:mb-4">معلومات الزبون</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">اسم الزبون</label>
                        <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100 font-medium">{viewingCheck.customers?.name || '—'}</p>
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">رقم الهاتف</label>
                        <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100">{viewingCheck.customers?.phone || '—'}</p>
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">رقم الزبون</label>
                        <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100">{viewingCheck.customer_id}</p>
                      </div>
                      {viewingCheck.customers?.balance !== undefined && (
                        <div>
                          <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">الرصيد</label>
                          <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100">₪{(viewingCheck.customers.balance || 0).toFixed(2)}</p>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {/* Check Info */}
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-slate-700 pb-2 mb-3 sm:mb-4">معلومات الشيك</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">رقم الشيك</label>
                        <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100 font-bold">{viewingCheck.check_id}</p>
                      ...
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">المبلغ</label>
                        <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100 font-bold">₪{(viewingCheck.amount || 0).toFixed(2)}</p>
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">تاريخ الإرجاع</label>
                        <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100">{formatDate(viewingCheck.return_date)}</p>
                      </div>
                      <div>
                        <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">الحالة</label>
                      ...
                      {viewingCheck.created_at && (
                        <div>
                          <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">تاريخ الإنشاء</label>
                          <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100">{formatDate(viewingCheck.created_at)}</p>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {viewingCheck.notes && (
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-slate-700 pb-2 mb-3 sm:mb-4">ملاحظات</h3>
                      <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100 whitespace-pre-wrap bg-gray-50 dark:bg-slate-800/50 p-3 rounded-lg">{viewingCheck.notes}</p>
                    </div>
                  )}

                  {/* Images */}
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-slate-700 pb-2 mb-3 sm:mb-4">صور الشيك</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      {viewingCheck.image_front && (
                        <div>
                          <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">صورة الوجه</label>
                          <div className="relative w-full h-48 sm:h-64 bg-gray-100 dark:bg-slate-700/50 rounded-lg overflow-hidden border border-gray-200 dark:border-slate-700">
                            <img
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="absolute top-2 left-2 px-2 py-1 bg-white dark:bg-slate-800/80 hover:bg-white rounded text-xs flex items-center gap-1"
                            >
                              <ImageIcon size={14} />
                              <span>فتح</span>
                            </a>
                      ...
                      {viewingCheck.image_back && (
                        <div>
                          <label className="block text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">صورة الخلف</label>
                          <div className="relative w-full h-48 sm:h-64 bg-gray-100 dark:bg-slate-700/50 rounded-lg overflow-hidden border border-gray-200 dark:border-slate-700">
                            <img
        ...
        {statusChangeModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4" dir="rtl">
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-md w-full p-4 sm:p-6 space-y-3 sm:space-y-4 max-h-[95vh] overflow-y-auto">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-100">تغيير الحالة</h3>
              <div className="space-y-3">
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">من</label>
                  <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-slate-800/50 px-3 py-2 rounded-lg">{statusChangeModal.currentStatus}</p>
                </div>
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">إلى</label>
                  <p className="text-sm sm:text-base text-gray-900 dark:text-gray-100 bg-blue-50 px-3 py-2 rounded-lg font-medium">{statusChangeModal.newStatus}</p>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2 sm:gap-3 pt-4 border-t border-gray-200 dark:border-slate-700">
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors font-medium text-sm sm:text-base"
                >
                  إلغاء
                </button>
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-gray-900 dark:bg-slate-700 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-slate-600 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                >
