...
function ShopSalesFormContent() {
  ...
  const handleAddProduct = (productParam?: any, quantityParam?: number, priceParam?: number) => {
    // Support both manual selection and barcode scanning
    ...
    <AdminLayout>
      <div className="space-y-6 font-cairo" dir="rtl">
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">فاتورة مبيعات محل جديدة</h1>
            <p className="text-gray-600 mt-1">إنشاء فاتورة مبيعات محل جديدة</p>
          </div>
