...
import { getShopSalesInvoices, updateShopSalesInvoiceSign, updateShopSalesInvoiceStatus } from '@/lib/api';
...
export default function ShopSalesPage() {
  ...
  const loadInvoices = async () => {
    ...
    setError(null);
    try {
      const result = await getShopSalesInvoices(currentPage, pageSize);
