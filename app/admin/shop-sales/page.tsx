            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-3 sm:px-4 py-3 border-b border-gray-200 bg-gray-50 flex-shrink-0">
                ...
                <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
                  <button
                    onClick={() => {
                      const printUrl = `/admin/shop-sales/print/${viewing.invoice.InvoiceID || viewing.invoice.invoice_id}`;
                      window.open(printUrl, `print-shop-invoice-${viewing.invoice.InvoiceID || viewing.invoice.invoice_id}`, 'noopener,noreferrer');
                    }}
