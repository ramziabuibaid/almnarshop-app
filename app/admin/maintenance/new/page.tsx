    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6 font-cairo" dir="rtl">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 font-cairo">إضافة سجل صيانة جديد</h1>
        </div>
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-4 sm:p-6 space-y-4 sm:space-y-8">
          {/* Customer Selection */}
          <div className="bg-gray-50 dark:bg-slate-800/50 rounded-lg p-3 sm:p-4 border border-gray-200 dark:border-slate-700">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-3">
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs sm:text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 hover:bg-white rounded-lg transition-colors border border-gray-300 dark:border-slate-600 font-cairo w-full sm:w-auto"
            ...
            />
            {!formData.customerID && (
              <p className="mt-2 text-xs text-gray-500 dark:text-gray-400 font-cairo">يرجى اختيار العميل من القائمة أو إضافة عميل جديد</p>
            )}
          </div>
          ...
          <div className="bg-gray-50 dark:bg-slate-800/50 rounded-lg p-3 sm:p-4 border border-gray-200 dark:border-slate-700 space-y-3 sm:space-y-4">
            ...
            <div>
              ...
              {!formData.itemName.trim() && (
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 font-cairo">يرجى إدخال اسم القطعة المراد صيانتها</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div>
                ...
                {!formData.company && (
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 font-cairo">يرجى اختيار الشركة الكفيلة</p>
                )}
              </div>
            </div>
          ...
          {/* Status */}
          <div className="bg-gray-50 dark:bg-slate-800/50 rounded-lg p-3 sm:p-4 border border-gray-200 dark:border-slate-700">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100 border-b border-gray-300 dark:border-slate-600 pb-2 mb-3 sm:mb-4 font-cairo">الحالة الأولية</h2>
            <select
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 font-cairo">يمكن تغيير الحالة لاحقاً من صفحة القائمة</p>
          </div>
