...
export default function OrdersPage() {
  ...
  const getStatusBadge = (status: string) => {
    const statusMap: Record<string, { label: string; className: string }> = {
      ...
      Completed: { label: 'مكتملة', className: 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' },
      Cancelled: { label: 'ملغاة', className: 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300' },
    };
    const statusInfo = statusMap[status] || { label: status, className: 'bg-gray-100 dark:bg-slate-700/50 text-gray-800 dark:text-gray-200' };
    return (
      ...
      <AdminLayout>
        <div className="flex items-center justify-center min-h-[60vh]" dir="rtl">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">جاري تحميل الطلبيات...</p>
          </div>
        </div>
      </AdminLayout>
    );
  ...
  return (
    <AdminLayout>
      <div className="space-y-4 sm:space-y-6 font-cairo" dir="rtl">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 font-cairo">طلبيات اون لاين</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1 text-sm sm:text-base font-cairo">إدارة طلبيات العملاء الأون لاين</p>
        </div>

        {error && (
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 text-red-700 dark:text-red-400 px-3 sm:px-4 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-cairo">
            {error}
          </div>
        )}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2 sm:gap-4">
          ...
          >
            <div className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 font-cairo">{orderStats.all}</div>
            <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1 font-cairo">الكل</div>
          </button>
          <button
            ...
            className={`p-3 sm:p-4 rounded-lg border-2 transition-all font-cairo ${
              statusFilter === 'Pending'
                ...
                : 'border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-yellow-200'
            }`}
          >
            <div className="text-xl sm:text-2xl font-bold text-yellow-700 font-cairo">{orderStats.pending}</div>
            <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1 font-cairo">قيد الانتظار</div>
          </button>
          <button
            ...
            className={`p-3 sm:p-4 rounded-lg border-2 transition-all font-cairo ${
              statusFilter === 'Processing'
                ...
                : 'border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-blue-200'
            }`}
          >
            <div className="text-xl sm:text-2xl font-bold text-blue-700 font-cairo">{orderStats.processing}</div>
            <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1 font-cairo">قيد المعالجة</div>
          </button>
          <button
            ...
            className={`p-3 sm:p-4 rounded-lg border-2 transition-all font-cairo ${
              statusFilter === 'Completed'
                ...
                : 'border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-green-200'
            }`}
          >
            <div className="text-xl sm:text-2xl font-bold text-green-700 dark:text-green-400 font-cairo">{orderStats.completed}</div>
            <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1 font-cairo">مكتملة</div>
          </button>
          <button
            ...
            className={`p-3 sm:p-4 rounded-lg border-2 transition-all font-cairo ${
              statusFilter === 'Cancelled'
                ...
                : 'border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-red-200'
            }`}
          >
            <div className="text-xl sm:text-2xl font-bold text-red-700 dark:text-red-400 font-cairo">{orderStats.cancelled}</div>
            <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1 font-cairo">ملغاة</div>
          </button>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <div className="w-full sm:w-auto sm:min-w-[180px]">
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 font-cairo text-sm sm:text-base"
              >
        ...
        {filteredOrders.length === 0 ? (
          <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-8 sm:p-12 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-base sm:text-lg font-cairo">لا توجد طلبيات</p>
          </div>
        ) : (
          <>
            {/* Desktop Table View */}
                ...
                <table className="w-full">
                  ...
                  <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200">
                    {filteredOrders.map((order) => (
                      <tr key={order.OrderID} className="hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors">
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100 font-cairo">
                          {order.OrderID}
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100 font-cairo">
                          {order.CustomerPhone}
                        </td>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className="relative">
                              <select
                                ...
                                className="text-xs px-2 py-1 border border-gray-300 dark:border-slate-600 rounded focus:outline-none focus:ring-1 focus:ring-gray-900 dark:focus:ring-gray-100 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 disabled:opacity-50 disabled:cursor-not-allowed max-h-32 overflow-y-auto font-cairo"
                              ...
                              {updatingStatus === order.OrderID && (
                                <Loader2 size={12} className="absolute left-1 top-1/2 transform -translate-y-1/2 animate-spin text-gray-400 dark:text-gray-500" />
                              )}
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 dark:text-gray-100 font-cairo">
                          {formatCurrency(order.TotalAmount)}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 font-cairo">
                          <div>
                            <div>{formatDate(order.CreatedAt)}</div>
                            <div className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{formatTime(order.CreatedAt)}</div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="text-green-600 dark:text-green-400 hover:text-green-900 flex items-center gap-1 font-cairo"
                            >
                              <Eye size={16} />
                              عرض
                            </button>
            ...
            <div className="md:hidden space-y-3">
              {filteredOrders.map((order) => (
                <div key={order.OrderID} className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-4 shadow-sm">
                  {/* Header Row */}
                  <div className="flex items-start justify-between mb-3 pb-3 border-b border-gray-200 dark:border-slate-700">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        <h3 className="text-base font-bold text-gray-900 dark:text-gray-100 font-cairo">#{order.OrderID}</h3>
                        {getStatusBadge(order.Status)}
                      </div>
                    </div>
                  ...
                  <div className="mb-3 space-y-2">
                    <div>
                      <div className="text-xs text-gray-500 dark:text-gray-400 font-cairo mb-1">اسم الزبون</div>
                    ...
                    <div>
                      <div className="text-xs text-gray-500 dark:text-gray-400 font-cairo mb-1">رقم الهاتف</div>
                      <div className="text-sm text-gray-900 dark:text-gray-100 font-cairo">{order.CustomerPhone}</div>
                    </div>
                  </div>

                  {/* Date */}
                  <div className="mb-3">
                    <div className="text-xs text-gray-500 dark:text-gray-400 font-cairo mb-1">التاريخ والوقت</div>
                    <div className="text-sm text-gray-900 dark:text-gray-100 font-cairo">
                      {formatDate(order.CreatedAt)}
                      <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{formatTime(order.CreatedAt)}</div>
                    </div>
                  </div>

                  {/* Status Dropdown */}
                  <div className="mb-3">
                    <div className="text-xs text-gray-500 dark:text-gray-400 font-cairo mb-1">تغيير الحالة</div>
                    <div className="relative">
                      <select
                        value={order.Status}
                        onChange={(e) => {
                        ...
                        disabled={updatingStatus === order.OrderID}
                        className="w-full text-sm px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 disabled:opacity-50 disabled:cursor-not-allowed font-cairo"
                      >
                        <option value="Pending">قيد الانتظار</option>
                        <option value="Processing">قيد المعالجة</option>
                        <option value="Completed">مكتملة</option>
                      ...
                      {updatingStatus === order.OrderID && (
                        <Loader2 size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 animate-spin text-gray-400 dark:text-gray-500" />
                      )}
                    </div>
                  </div>
        ...
        {selectedOrder && (
          <div className="fixed inset-0 bg-black/50 z-[80] flex items-center justify-center p-2 sm:p-4" dir="rtl">
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[95vh] overflow-hidden flex flex-col">
              <div className="sticky top-0 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 flex-shrink-0">
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-100 font-cairo">تفاصيل الطلبية</h3>
              ...
              <div className="p-3 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto flex-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1 font-cairo">رقم الطلبية</p>
                    <p className="font-semibold text-gray-900 dark:text-gray-100 font-cairo">{selectedOrder.OrderID}</p>
                  </div>
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1 font-cairo">الحالة</p>
                    <div>{getStatusBadge(selectedOrder.Status)}</div>
                  </div>
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1 font-cairo">اسم الزبون</p>
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1 font-cairo">رقم الهاتف</p>
                    <p className="font-semibold text-gray-900 dark:text-gray-100 font-cairo">{selectedOrder.CustomerPhone}</p>
                  </div>
                  {selectedOrder.CustomerEmail && (
                    <div>
                      <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1 font-cairo">البريد الإلكتروني</p>
                      <p className="font-semibold text-gray-900 dark:text-gray-100 font-cairo break-all">{selectedOrder.CustomerEmail}</p>
                    </div>
                  )}
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1 font-cairo">التاريخ والوقت</p>
                    <p className="font-semibold text-gray-900 dark:text-gray-100 font-cairo">{formatDate(selectedOrder.CreatedAt)}</p>
                  </div>
                </div>

                {/* Order Items */}
                <div>
                  <h4 className="text-base sm:text-lg font-bold text-gray-900 dark:text-gray-100 mb-3 sm:mb-4 font-cairo">الأصناف</h4>
                  {loadingDetails ? (
                    <div className="flex items-center justify-center py-8">
                      <Loader2 size={24} className="animate-spin text-gray-400 dark:text-gray-500" />
                    </div>
                  ) : orderDetails.length === 0 ? (
                    <p className="text-gray-500 dark:text-gray-400 text-center py-8 font-cairo">لا توجد أصناف</p>
                  ) : (
                    <div className="border border-gray-200 dark:border-slate-700 rounded-lg overflow-hidden overflow-x-auto">
                      <table className="w-full text-xs sm:text-sm min-w-[500px]">
                        <thead className="bg-gray-50 dark:bg-slate-800/50 border-b border-gray-200 dark:border-slate-700">
                          <tr>
                            <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase font-cairo">
                              اسم الصنف
                            </th>
                            <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase font-cairo">
                              الكمية
                            </th>
                            <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase font-cairo">
                              سعر الوحدة
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {orderDetails.map((detail) => (
                            <tr key={detail.DetailID}>
                              <td className="px-4 py-3 text-sm text-gray-900 dark:text-gray-100 font-cairo">
                                <button
                                  type="button"
                                  onClick={(e) => {
                              ...
                              <td className="px-4 py-3 text-sm text-center text-gray-900 dark:text-gray-100 font-cairo">{detail.Quantity}</td>
                              <td className="px-4 py-3 text-sm text-right text-gray-900 dark:text-gray-100 font-cairo">
                                {formatCurrency(detail.UnitPrice)}
                              </td>
                              <td className="px-4 py-3 text-sm text-right font-semibold text-gray-900 dark:text-gray-100 font-cairo">
                        ...
                        <tfoot className="bg-gray-50 dark:bg-slate-800/50 border-t border-gray-200 dark:border-slate-700">
                          <tr>
                            <td colSpan={3} className="px-4 py-3 text-sm font-semibold text-gray-900 dark:text-gray-100 text-right font-cairo">
                              الإجمالي:
                            </td>
                            <td className="px-4 py-3 text-sm font-bold text-gray-900 dark:text-gray-100 text-right font-cairo">
                ...
                {selectedOrder.Notes && (
                  <div>
                    <h4 className="text-base sm:text-lg font-bold text-gray-900 dark:text-gray-100 mb-2 font-cairo">ملاحظات</h4>
                    <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-slate-800/50 p-3 sm:p-4 rounded-lg whitespace-pre-wrap font-cairo">
                      {selectedOrder.Notes}
                    </p>
                  </div>
                )}
          ...
          >
            ...
            >
              <div className="flex items-center justify-between gap-2 px-3 py-2 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50 flex-shrink-0">
                <span className="text-sm font-cairo text-gray-700 dark:text-gray-300">معاينة الطباعة — طلبية أون لاين</span>
                <div className="flex items-center gap-2">
                  <button
                    type="button"
