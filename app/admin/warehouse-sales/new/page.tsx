      ...
      <div className="space-y-6 font-cairo" dir="rtl">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 font-cairo">فاتورة مبيعات مخزن جديدة</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1 text-sm sm:text-base font-cairo">إنشاء فاتورة مبيعات مخزن جديدة</p>
          </div>
                  ...
                  {details.map((item, index) => {
                    ...
                    return (
                      <div key={item.detailID || index} className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-4 shadow-sm">
                        ...
                        {showCosts && canViewCost && (
                          <div className="pt-2 border-t border-gray-200 dark:border-slate-700 mb-3">
