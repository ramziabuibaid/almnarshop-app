    ...
    <AdminLayout>
      <div className="space-y-6 font-cairo" dir="rtl">
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">عرض سعري جديد</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">إنشاء عرض سعري جديد</p>
          </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-4 sm:p-6 space-y-4 sm:space-y-6">
          ...
          {/* Actions */}
          <div className="flex items-center justify-end gap-4 pt-4 border-t border-gray-200 dark:border-slate-700">
            <button
              onClick={() => router.push('/admin/quotations')}
