...
export default function TasksPage() {
  ...
  return (
    <AdminLayout>
      ...
      {toast.message && (
        <div
          className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 px-6 py-4 rounded-lg shadow-lg flex items-center gap-3 font-cairo transition-all duration-300 ${
            toast.type === 'success'
